...
class cnnCIFAR10():
    ...
    def build_graph(self):
        ...
        w1 = tf.constant(pickle.load(open("weights", 'rb')))
        W_conv1 = tf.Variable(w1)
        b1 = tf.constant(pickle.load(open("biases", 'rb')))
        b_conv1 = tf.Variable(b1)
        ...
        w2 = tf.constant(pickle.load(open("weights2", 'rb')))
        W_conv2 = tf.Variable(w2)
        b2 = tf.constant(pickle.load(open("biases2", 'rb')))
        b_conv2 = tf.Variable(b2)
