...
training_features = features[0:4000]
testing_features = features[50000:51000]
trY = np.load("trY.npy")
teY = np.load("teY.npy")
...
print("fitting")
clf = svm.SVC()
clf.fit(training_features, trY[:4000])
print("fitted")
...
# Show results
print("CNN Accuracy: {}".format(accuracy_score(teY[:1000], prY)))
print(prY)
...
# Show results
print("DAE Accuracy: {}".format(accuracy_score(teY[:1000], prY)))
print(prY)
